...
export class ExperienceTiles {
    ...
    setView() {
        appendChildren(this.view, [
            ...
            addEvent(addClasses(createSVGButton('portal/frontend/assets/icons/Edit.svg'), 'experienceTiles_updateButton'), () => { const close = this.parentProps.displayBox(new UpdateExperience(this.parentProps, this.experienceEntry, () => { close() }, () => { this.refresh() }).view) }),
            addEvent(addClasses(createSVGButton('portal/frontend/assets/icons/Delete.svg'), 'experienceTiles_deleteButton'), async () => {
