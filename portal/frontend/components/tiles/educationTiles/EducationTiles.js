...
export class EducationTiles {
    ...
    setView() {
        appendChildren(this.view, [
            ...
            addEvent(addClasses(createSVGButton('portal/frontend/assets/icons/Edit.svg'), 'educationTiles_updateButton'), () => { const close = this.parentProps.displayBox(new UpdateEducation(this.parentProps, this.educationEntry, () => { close() }, () => { this.refresh() }).view) }),
            addEvent(addClasses(createSVGButton('portal/frontend/assets/icons/Delete.svg'), 'educationTiles_deleteButton'), async () => {
