...
export class WorkExperience {
    ...
    async fetch() {
        ...
        await fetch( 'service/backend/controllers/GET/getExperience.php' )
    ...
    setView() {
        appendChildren(this.view, [
            ...
            addEvent(addClasses(createSVGButton('portal/frontend/assets/icons/Plus.svg'), 'resumeView_addButton'), () => { const close = this.parentProps.displayBox(new AddExperience(this.parentProps, () => { close() }, () => { detachChildren(this.view); this.fetch(); }).view) })
        ])
    }
}