...
export class Skills {
    ...
    async fetch() {
        ...
        await fetch( 'service/backend/controllers/GET/getSkills.php' )
    ...
    setView() {
        appendChildren(this.view, [
            ...
            addEvent(addClasses(createSVGButton('portal/frontend/assets/icons/Plus.svg'), 'skills_addButton'), () => { const close = this.parentProps.displayBox(new AddSkills(this.parentProps, () => { close() }, () => { detachChildren(this.view); this.fetch(); }).view) })
        ]);
    }
}