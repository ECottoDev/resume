...
export class NavigationBar {
    ...
    setView() {
        appendChildren(this.view, [
            addEvent(addClasses(createSVGButton('portal/frontend/assets/icons/Home.svg'), 'navigationBar_homeIcon'), () => { this.parentProps.setNavState(routes.HOME_VIEW) }),
            addClasses(createHeadingText('Home'), 'navigationBar_homeText'),
            addEvent(addClasses(createSVGButton('portal/frontend/assets/icons/WebPage.svg'), 'navigationBar_webPageIcon'), () => { this.parentProps.setNavState(routes.BRAND_VIEW) }),
